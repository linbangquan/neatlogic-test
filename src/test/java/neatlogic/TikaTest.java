...
public class TikaTest {
    ...
    * @return
    ...
    public void typeDetection() throws IOException {
        ...
        File file = new File("C:\\Users\\89770\\Desktop\\desktop\\inti.sql");//测试ddd
    ...
    * @return
    ...
    public void getXMLContent() throws IOException, TikaException, SAXException {
        ...
        BodyContentHandler handler = new BodyContentHandler();
        Metadata metadata = new Metadata();
        FileInputStream inputstream = new FileInputStream(new File("C:\\Users\\89770\\git\\neatlogic-test\\pom.xml"));
        ParseContext pcontext = new ParseContext();
        //Xml parser
